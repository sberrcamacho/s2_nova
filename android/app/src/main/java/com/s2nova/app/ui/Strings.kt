...
private val ES: Map<StringKey, String> = mapOf(
    ...
    StringKey.ADD_TXN_ERROR_WALLET to "Selecciona una billetera.",
    StringKey.ADD_TXN_ERROR_TRANSFER_WALLET to "Selecciona la billetera de destino.",
    StringKey.ADD_TXN_NO_WALLET_TITLE to "Aún no tienes billeteras",
    StringKey.ADD_TXN_NO_WALLET_SUBTITLE to "Crea una billetera (efectivo, banco, ahorros...) antes de registrar movimientos.",
    StringKey.ADD_TXN_NO_WALLET_CTA to "Crear billetera",
    ...
    StringKey.WALLETS_FOOTER_NOTE to "El saldo total de Inicio es la suma de estas billeteras.",
    ...
    StringKey.GOAL_CONTRIBUTION_ERROR_WALLET to "Elige una billetera de origen.",
    ...
    StringKey.ONBOARDING_WALLET_TITLE to "Crea tu primera billetera",
    ...
    StringKey.ONBOARDING_TUTORIAL_TRACK_BODY to "Registra ingresos, gastos y transferencias entre tus billeteras en segundos.",
    ...
    StringKey.ONBOARDING_TUTORIAL_ORGANIZE_BODY to "Crea billeteras, presupuestos y objetivos para mantener todo en orden.",
