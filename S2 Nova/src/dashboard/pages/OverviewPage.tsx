    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-3">
        ...
        <ChartCard
          ...
          action={
            <button onClick={() => navigate('/dashboard/budgets')} className="flex items-center gap-0.5 text-xs font-bold text-primary">
      ...
      <Card className="p-5 sm:p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button onClick={() => navigate('/dashboard/transactions')} className="flex items-center gap-0.5 text-xs font-bold text-primary">
