...
const dictionary = {
  ...
  "aj.title": { es: "Ajustes", en: "Settings" },
  "aj.subtitle": { es: "Cuenta, preferencias y seguridad", en: "Account, preferences and security" },
  "aj.back": { es: "← Ajustes", en: "← Settings" },
  "aj.memberSince": { es: "Miembro desde {0}", en: "Member since {0}" },
  "aj.editProfile": { es: "Editar perfil", en: "Edit profile" },
  "aj.preferences": { es: "Preferencias", en: "Preferences" },
  "aj.language": { es: "Idioma", en: "Language" },
  "aj.languageHint": { es: "Aplica a textos, gráficos y fechas", en: "Applies to text, charts and dates" },
  "aj.currency": { es: "Moneda", en: "Currency" },
  "aj.currencyCOP": { es: "Peso colombiano, sin decimales · {0}", en: "Colombian peso, no decimals · {0}" },
  "aj.currencyUSD": { es: "Dólar, 2 decimales, tasa de referencia fija · {0}", en: "Dollar, 2 decimals, fixed reference rate · {0}" },
  "aj.currencyOptCOP": { es: "COP · Peso colombiano", en: "COP · Colombian peso" },
  "aj.currencyOptUSD": { es: "USD · Dólar", en: "USD · Dollar" },
  "aj.theme": { es: "Tema", en: "Theme" },
  "aj.themeHint": { es: "Por defecto sigue el tema del sistema", en: "Follows the system theme by default" },
  "aj.themeLight": { es: "Claro", en: "Light" },
  "aj.themeDark": { es: "Oscuro", en: "Dark" },
  "aj.themeSystem": { es: "Sistema", en: "System" },
  "aj.notifications": { es: "Notificaciones", en: "Notifications" },
  "aj.notificationsHint": { es: "Presupuestos, vencimientos de programados y préstamos", en: "Budgets, scheduled items and loans coming due" },
  "aj.hideAmounts": { es: "Ocultar montos", en: "Hide amounts" },
  "aj.hideAmountsHint": { es: "Difumina los montos hasta que los muestres con el ojo del saldo", en: "Blurs amounts until you reveal them with the balance eye" },
  "aj.security": { es: "Seguridad", en: "Security" },
  "aj.password": { es: "Contraseña", en: "Password" },
  "aj.passwordChanged": { es: "Cambiada {0}", en: "Changed {0}" },
  "aj.passwordNone": { es: "Entras con Google; aún no tienes contraseña", en: "You sign in with Google; no password yet" },
  "aj.change": { es: "Cambiar", en: "Change" },
  "aj.sessions": { es: "Sesiones activas", en: "Active sessions" },
  "aj.thisBrowser": { es: "Este navegador", en: "This browser" },
  "aj.manage": { es: "Administrar", en: "Manage" },
  "aj.deleteAccount": { es: "Eliminar cuenta", en: "Delete account" },
  "aj.deleteAccountHint": { es: "Borra movimientos, presupuestos, metas y préstamos", en: "Erases transactions, budgets, goals and loans" },
  "aj.delete": { es: "Eliminar", en: "Delete" },
  "aj.cancel": { es: "Cancelar", en: "Cancel" },
  "aj.ago.now": { es: "hace un momento", en: "just now" },
  "aj.ago.minute": { es: "hace 1 minuto", en: "1 minute ago" },
  "aj.ago.minutes": { es: "hace {0} minutos", en: "{0} minutes ago" },
  "aj.ago.hour": { es: "hace 1 hora", en: "1 hour ago" },
  "aj.ago.hours": { es: "hace {0} horas", en: "{0} hours ago" },
  "aj.ago.day": { es: "hace 1 día", en: "1 day ago" },
  "aj.ago.days": { es: "hace {0} días", en: "{0} days ago" },
  "aj.ago.month": { es: "hace 1 mes", en: "1 month ago" },
  "aj.ago.months": { es: "hace {0} meses", en: "{0} months ago" },
  "aj.ago.year": { es: "hace 1 año", en: "1 year ago" },
  "aj.ago.years": { es: "hace {0} años", en: "{0} years ago" },
  "aj.pw.title": { es: "Cambiar contraseña", en: "Change password" },
  "aj.pw.subtitle": { es: "Al cambiarla se cierran las sesiones en tus otros dispositivos.", en: "Changing it signs you out on your other devices." },
  "aj.pw.current": { es: "CONTRASEÑA ACTUAL", en: "CURRENT PASSWORD" },
  "aj.pw.next": { es: "NUEVA CONTRASEÑA", en: "NEW PASSWORD" },
  "aj.pw.confirm": { es: "CONFIRMAR NUEVA CONTRASEÑA", en: "CONFIRM NEW PASSWORD" },
  "aj.pw.nextPlaceholder": { es: "Mínimo 8 caracteres", en: "At least 8 characters" },
  "aj.pw.confirmPlaceholder": { es: "Repite la nueva contraseña", en: "Repeat the new password" },
  "aj.pw.ruleLength": { es: "Mínimo 8 caracteres", en: "At least 8 characters" },
  "aj.pw.ruleNumber": { es: "Incluye un número", en: "Includes a number" },
  "aj.pw.ruleMatch": { es: "Las contraseñas coinciden", en: "Passwords match" },
  "aj.pw.errCurrent": { es: "Escribe tu contraseña actual.", en: "Enter your current password." },
  "aj.pw.errRules": { es: "La nueva contraseña no cumple todos los requisitos.", en: "The new password doesn't meet every requirement." },
  "aj.pw.errSame": { es: "La nueva contraseña debe ser distinta de la actual.", en: "The new password must differ from the current one." },
  "aj.pw.errWrong": { es: "La contraseña actual no es correcta.", en: "The current password is incorrect." },
  "aj.pw.done": { es: "Contraseña actualizada. Cerramos tus otras sesiones.", en: "Password updated. We signed out your other sessions." },
  "aj.pw.submit": { es: "Actualizar contraseña", en: "Update password" },
  "aj.ses.subtitle": { es: "Dispositivos con tu cuenta abierta.", en: "Devices signed in to your account." },
  "aj.ses.closeOthers": { es: "Cerrar las demás", en: "Sign out the rest" },
  "aj.ses.thisDevice": { es: "Este dispositivo", en: "This device" },
  "aj.ses.signOut": { es: "Cerrar sesión", en: "Sign out" },
  "aj.ses.activeNow": { es: "Activa ahora", en: "Active now" },
  "aj.ses.unknown": { es: "Dispositivo desconocido", en: "Unknown device" },
  "aj.pr.subtitle": { es: "Se muestra en tu cuenta, en Android y en los reportes exportados.", en: "Shown on your account, on Android and in exported reports." },
  "aj.pr.avatarHint": { es: "Tus iniciales se usan como avatar.", en: "Your initials are used as your avatar." },
  "aj.pr.name": { es: "NOMBRE COMPLETO", en: "FULL NAME" },
  "aj.pr.email": { es: "CORREO", en: "EMAIL" },
  "aj.pr.phone": { es: "TELÉFONO", en: "PHONE" },
  "aj.pr.city": { es: "CIUDAD", en: "CITY" },
  "aj.pr.namePlaceholder": { es: "Tu nombre", en: "Your name" },
  "aj.pr.emailPlaceholder": { es: "nombre@correo.com", en: "name@email.com" },
  "aj.pr.cityPlaceholder": { es: "Ciudad", en: "City" },
  "aj.pr.emailPassword": { es: "CONTRASEÑA ACTUAL PARA CAMBIAR EL CORREO", en: "CURRENT PASSWORD TO CHANGE THE EMAIL" },
  "aj.pr.errName": { es: "Escribe tu nombre completo.", en: "Enter your full name." },
  "aj.pr.errEmail": { es: "Escribe un correo válido.", en: "Enter a valid email." },
  "aj.pr.errEmailPassword": { es: "Escribe tu contraseña actual para cambiar el correo.", en: "Enter your current password to change the email." },
  "aj.pr.errNoPassword": { es: "Crea una contraseña antes de cambiar el correo.", en: "Create a password before changing the email." },
  "aj.pr.errEmailTaken": { es: "Ya existe una cuenta con ese correo.", en: "An account with that email already exists." },
  "aj.pr.save": { es: "Guardar cambios", en: "Save changes" },
  "aj.pr.saved": { es: "Perfil actualizado", en: "Profile updated" },
  "aj.del.subtitle": { es: "Borra de forma permanente tus datos de S2 Nova en Web y Android.", en: "Permanently erases your S2 Nova data on Web and Android." },
  "aj.del.what": { es: "Qué se borra", en: "What gets erased" },
  "aj.del.movements": { es: "{0} y todo su historial", en: "{0} and all their history" },
  "aj.del.plans": { es: "{0}, {1} y {2}", en: "{0}, {1} and {2}" },
  "aj.del.wallets": { es: "{0} y todos tus programados", en: "{0} and all your scheduled items" },
  "aj.del.profile": { es: "Tu perfil y tus sesiones en todos los dispositivos", en: "Your profile and your sessions on every device" },
  "aj.del.n.movement": { es: "movimiento|movimientos", en: "transaction|transactions" },
  "aj.del.n.budget": { es: "presupuesto|presupuestos", en: "budget|budgets" },
  "aj.del.n.goal": { es: "meta|metas", en: "goal|goals" },
  "aj.del.n.loan": { es: "préstamo|préstamos", en: "loan|loans" },
  "aj.del.n.wallet": { es: "billetera|billeteras", en: "wallet|wallets" },
  "aj.del.copy": { es: "Guardar una copia", en: "Keep a copy" },
  "aj.del.copyHint": { es: "CSV con movimientos, presupuestos, metas y préstamos", en: "CSV with transactions, budgets, goals and loans" },
  "aj.del.export": { es: "Exportar datos", en: "Export data" },
  "aj.del.exported": { es: "Copia descargada en CSV.", en: "CSV copy downloaded." },
  "aj.del.confirm": { es: "ESCRIBE ELIMINAR PARA CONFIRMAR", en: "TYPE ELIMINAR TO CONFIRM" },
  "aj.del.password": { es: "CONTRASEÑA ACTUAL", en: "CURRENT PASSWORD" },
  "aj.del.ack": { es: "Entiendo que esto no se puede deshacer.", en: "I understand this can't be undone." },
  "aj.del.submit": { es: "Eliminar cuenta definitivamente", en: "Delete account permanently" },
  "aj.del.noPassword": { es: "Crea una contraseña antes de eliminar la cuenta.", en: "Create a password before deleting the account." },
